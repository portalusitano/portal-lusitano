 ...
 *
 * É o desenho de recurso: entra quando o globo de tiles não consegue chegar
 * ao seu fornecedor — rede fechada, servidor em baixo, um bloqueio pelo
 * caminho. Não depende de ninguém e não pede chave, por isso o mapa nunca
 * fica um rectângulo vazio; era exactamente esse o defeito que se foi
 * corrigir, quando os tiles do Carto vinham com «API KEY REQUIRED»
 * carimbado por cima do país inteiro.
 *
...
export default function GloboCanvas({ coudelarias, flyTo, onMarkerClick }: Props) {
