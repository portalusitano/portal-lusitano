...
export default function UserMenu() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <div className="w-8 h-8 rounded-full bg-[var(--foreground-strong)] flex items-center justify-center text-black text-sm font-bold">
          {initial}
        </div>
        ...
        <div className="absolute right-0 top-full mt-2 w-56 bg-[var(--background-secondary)] border border-[var(--border)] rounded-xl shadow-2xl overflow-hidden z-50">
          ...
          <div className="py-1">
            ...
            <LocalizedLink
              href="/minha-conta/anuncios"
              onClick={() => setOpen(false)}
              className="flex items-center gap-3 px-4 py-2.5 text-sm text-[var(--foreground-muted)] hover:bg-[var(--surface-hover)] transition-colors"
            >
              <Crown size={16} />
              {t.nav.tools} PRO
            </LocalizedLink>
