  ...
  return (
    <div className="bg-[var(--background-secondary)]/50 cartao p-6">
      ...
      <div className="space-y-6">
        ...
        {/* «Negociável» fica à vista porque é o que o cartão do anúncio mostra
            ao lado do preço. As outras nove condições de venda estão fechadas
            mais abaixo. */}
        ...
        <Detalhes
          ...
          campos={12}
          nota={tr(
            "Opcional. Troca, trial, transporte, exportação, visitas.",
            "Optional. Trade, trial, transport, export, viewings.",
            "Opcional. Cambio, prueba, transporte, exportación, visitas."
          )}
        >
          <div className="flex flex-wrap gap-4">
            <label
